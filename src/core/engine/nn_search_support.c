...
#define hce_phase_inc nn_search_phase_inc
...
#define hce_attackers_to_square nn_search_attackers_to_square
#define hce_eval_cp_stm nn_search_legacy_eval_cp_stm
#define hce_experimental_eval_cp_stm nn_search_legacy_experimental_eval_cp_stm
#define hce_eval_breakdown nn_search_legacy_eval_breakdown
